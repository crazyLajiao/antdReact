        ...
        return (
            <div>
                ...
                <Card title="Tab带图的页签" className="card-wrap">
                    <Tabs defaultActiveKey="1" onChange={this.handleCallBack}>
                       <TabPane tab={<span><PlusOutlined />增加</span>} key="1">欢迎使用柳柳版页签</TabPane>
                       <TabPane tab={<span><EditOutlined />编辑</span>} key="2">欢迎使用柳柳版页签</TabPane>
                       <TabPane tab={<span><DeleteOutlined />删除</span>} key="3">欢迎使用柳柳版页签</TabPane>
                    </Tabs>
                </Card>
